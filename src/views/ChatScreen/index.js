...
const logo = require('../../../images/3969584.png')
const nextLogo = require('../../../images/chevron-down-2.png')
const displayBar2 = require('../../../images/bar1.png')
const displayBar1 = require('../../../images/bar2.png')
...
export default function ChatScreen({navigation}){
  ...
  return(
    ...
    <Text style={{fontSize:17,color:'white'}}>
          Contact the technician you like to discuss project details.
    </Text>
    </View>   
    </View>
    ...
    <TouchableHighlight onPress={()=>navigation.navigate('HireScreen')}>
